        ...
        <section class="login_left">
          ...
          <section class="login_form">
            ...
            <section style="display: flex;flex-direction: row">
              <section class="login_password" style="width: 193px">
                <input type="text" placeholder="输入验证码" v-model="regCode" style="width: 100px">
              </section>
              <section>
      ...
      login(){
        ...
        if(this.phoneNumber == "" || !myreg.test(this.phoneNumber)){
          ...
          if(this.regCode.length>=7){
            alert('验证码为6位')
            return false
          }else if(this.regCode.length<6){
            alert('验证码为6位')
            return false
          }
        }
        apiRequest.codeLogin({
          phone:this.phoneNumber,
